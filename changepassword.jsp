...
<div class="grid_3">
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        <a href="login1.jsp"><i class="fa fa-home home_1"></i></a>
			...
			<div class="col-sm-8 row_1">
				<table class="table_working_hours">
		        	<tbody>
		        		 ...
		        		 Current Password<input type="password" name="cp" required> <br>
                                         New Password<input type="password" name="np" required> <br>
                                         Repeat Password<input type="password" name="rp" required> <br>
