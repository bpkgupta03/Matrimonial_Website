<%-- 
    Document   : index
    Created on : Jul 30, 2019, 6:48:31 PM
    Author     : bpkhandelwal
--%>
  ...
  <div class="container">
   ...
   <div class="services">
   	  <div class="col-sm-6 login_left">
		      ...
		      <label for="edit-name">Serial_no <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="sn" size="60" maxlength="60" class="form-text required">
		    </div>
		  
                  <div class="form-group">
		      <label for="edit-name">Email_Id <span class="form-required" title="This field is required.">*</span></label>
	...
	<div class="clearfix"> </div>
		    ...
		    <div class="age_select">
		      <label for="edit-pass">Create Profile For<span class="form-required" title="This field is required.">*</span></label>
		        <div class="age_grid">
		      ...
		      <input type="text" id="edit-name" name="user" size="60" maxlength="60" class="form-text required">
		    </div>
		      ...
		      <input type="text" id="edit-name" name="mobile" size="60" maxlength="60" class="form-text required">
		    </div>
