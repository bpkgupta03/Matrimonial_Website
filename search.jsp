<%-- 
    Document   : index
    Created on : Jul 26, 2019, 11:02:16 AM
    Author     : bpkhandelwal
--%>
...
<div class="grid_3">
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        <a href="search.jsp"><i class="fa fa-home home_1"></i></a>
...
<div class="col-md-9 search_left">
    <form method="post" action="view_profile.jsp">	
   <div class="form_but1">
   ...
   <div class="form-actions">
            <input type="submit" id="edit-submit"  value="Search" class="btn_1 submit">
   </div>    
 </form>
