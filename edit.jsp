<%-- 
    ...
    Created on : Jul 26, 2019, 11:50:20 AM
    Author     : bpkhandelwal
--%>
...
<div class="grid_3">
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        <a href="changepassword.jsp"><i class="fa fa-home home_1"></i></a>
			...
			<div class="col-sm-8 row_1">
				<table class="table_working_hours">
		        	<tbody>
		        		...
		        		<tr class="opened_1">
							<td class="day_label">Create Profile for :</td>
                                                        <td colspan="2">
                                                        <select name="profile"  >
                                                             <option value="select"><%=rs.getString(3)%></option>
					    ...
					    <tr class="opened">
							<td class="day_label">Name :</td>
                                        	        <td class="day_value"><input type="text" name="user" value="<%=rs.getString(5) %>"</td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Date of Birth :</td>
                                                        <td class="day_value"><input type="date" name="dob" value="<%=rs.getString(6) %>"</td>
						</tr>
					    ...
					    <tr class="opened">
							<td class="day_label">Marital Status :</td>    
                                                        <td colspan="2">
                                                            <select name='marital'>
                                                           <option value="select"><%=rs.getString(8)%></option>
                                                          <option value='Married'>Married</option>
                                                          <option value="Unmarried">Unmarried</option>
                                                          <option value='Divorced'>Divorce</option>
                                                          <option value="Widowed">Widowed</option>
                                                          <option value="Annuled">Annulet</option>
                                                      </select>
                                                        </td>                            
                                                         </tr>
						...
						<tr class="opened">
							<td class="day_label">Mother Tongue :</td>
                                                        <td colspan="2">
                                                        <select name='mt'>
                                                     <option value="select"><%=rs.getString(9)%></option>
					    ...
					    <tr class="closed">
							<td class="day_label">Religion :</td> 
                                                        <td colspan="2">
                                                            ...
                                                            <option value="select"><%=rs.getString(10)%></option>
					    ...
					    <tr class="closed">
							<td class="day_label">Caste :</td>     
                                                        <td colspan="2">
                                                            <select name='caste' >
                                                        <option value="select"><%=rs.getString(11)%></option>
					    ...
					    <tr class="closed">
							<td class="day_label">Mobile no :</td>  
                                                        <td class="day_value"><input type="text" name="mob" value="<%=rs.getString(12) %>"</td>
