      ...
      <h2>254879</h2>
       ...
       <% 
         try{ 
                        ...
                        ResultSet rs=st.executeQuery("select * from matrimonial where code='"+code+"' ");
                        ...
                        while(rs.next()){
	        		       ...
	        		       <tr class="opened">
							...
							<td class="day_value"><%=rs.getString(5)%></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Date of Birth :</td>
							<td class="day_value"><%=rs.getString(6)%></td>
						</tr>
						
					    <tr class="opened">
							<td class="day_label">Height :</td>
							<td class="day_value"><%=rs.getInt(7)%></td>
						</tr>
						
					    <tr class="opened">
							<td class="day_label">Marital Status :</td>
							<td class="day_value"><%=rs.getString(8)%></td>
						</tr>
					    
					    
						<tr class="opened">
							<td class="day_label">Mother Tongue :</td>
							<td class="day_value"><%=rs.getString(9)%></td>
						</tr>
				
                                                <tr class="opened">
							<td class="day_label">Religion:</td>
							<td class="day_value"><%=rs.getString(10)%></td>
						<tr class="opened">
							<td class="day_label">Caste :</td>
							<td class="day_value"><%=rs.getString(11)%></td>
						<tr class="opened">
							<td class="day_label">City :</td>
							<td class="day_value"><%=rs.getString(12)%></td>
						<tr class="opened">
							<td class="day_label">Mobile_no :</td>
							<td class="day_value"><%=rs.getString(13)%></td>
						
			    </tbody>
                             </table> 
                                    
          <ul class="login_details">
			      <li>Already a member? <a href="login1.jsp">Login Now</a></li>
			      <li>If not a member? <a href="index.jsp">Register Now</a></li>
			    </ul>
                                      </div>                               
         <form method="post" action="msg.jsp?id=<%=rs.getString(15)%>">                                               
          <div class="buttons">
             <div class="vertical">Send Mail</div></div>
               <div class="form-actions">
              <input type="text" name="msg" placeholder="Enter Message" class="btn_1">
              <input type="submit" value="Send" class="btn_1 submit"></div>
             </div>
          </div>
         </form>
          <div class="clearfix"></div>
