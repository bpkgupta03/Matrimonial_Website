      ...
      <h2>254879</h2>
       ...
       <% 
         try{ 
                        ...
                        ResultSet rs=st.executeQuery("select * from matrimonial where Gender='"+gender+"'AND Religion='"+religion+"' AND Caste='"+caste+"' ");
			   ...
			   <div class="vertical">Send Mail</div>
                           <div class="vertical"><a href="user_profile.jsp?id=<%=rs.getString(15)%>"</a>View Profile</div>
