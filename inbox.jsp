			   ...
			   <div id="myTabContent" class="tab-content">
				  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
	                ...
	                <div class="clearfix"> </div>
                                ...
                                try{
                                         //  Class.forName("com.mysql.jdbc.Driver");
                                              ...
                                              Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root","");
                                                ...
                                                int next=id+1;
                                                int pre=id-1;
                                           ResultSet rs=st.executeQuery("select * from inbox where temail='"+email+"' order by sn desc limit "+start+","+n);
                                           while(rs.next()){
                                                Statement st1=cn.createStatement();
                                                    ResultSet rs1=st1.executeQuery("select * from matrimonial where email='"+rs.getString(4)+"' ");
                                                   if(rs1.next()){
				        ...
				        <div class="thumb"><a href="user_profile.jsp"><img src="images/s3.jpg" class="img-responsive" alt=""/></a></div>
					    <div class="jobs_right">
							<h6 class="title"><a href="user_profile.jsp?id=<%=rs1.getString(15)%>"><%=rs1.getString(5)%></a></h6>
							<ul class="top-btns">
							  <li><a href="#" class="fa fa-facebook"></a></li>
							  <li><a href="#" class="fa fa-twitter"></a></li>
							  <li><a href="#" class="fa fa-google-plus"></a></li>
							</ul>
							<ul class="Message_details1">
						...
						<div class="clearfix"> </div>
					   	   ...
					   	   <div class="thumb_but"><a href="inbox.jsp?page=<%=pre%>" class="photo_view">Previous</a></div>
					   	  <div class="thumb"><a href="inbox.jsp?page=<%=next%>" class="photo_view">Next</a></div>
